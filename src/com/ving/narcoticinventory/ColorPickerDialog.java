...
public class ColorPickerDialog extends Dialog {
	...
	public interface OnColorChangedListener {
		void colorChanged(int key, int color);
	}
	...
	private static class ColorPickerView extends View {
		...
		public boolean onTouchEvent(MotionEvent event) {
			...
			if (x > 10 && x < 138 && y > 316 && y < 356)
				mListener.colorChanged(ColorAndSize.UNDEF, mCurrentColor);

			// If the touch event is located in the right button, notify the
			// listener with the default color
			if (x > 138 && x < 266 && y > 316 && y < 356)
				mListener.colorChanged(ColorAndSize.UNDEF, mDefaultColor);
	...
	public ColorPickerDialog(Context context, OnColorChangedListener listener,
			int key, int initialColor, int defaultColor) {
		super(context);
